...
public class BlockGoldenApple extends BlockEdible {
	public BlockGoldenApple(String name, Material mat, List<Block> blockList, List<Item> itemList, int lvl, float sat) {
