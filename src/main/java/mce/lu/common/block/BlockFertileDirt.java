...
public class BlockFertileDirt extends BlockBase {
	public BlockFertileDirt(String name, Material mat, List<Block> blockList, List<Item> itemList) {
	...
	public void updateTick(World world, BlockPos pos, IBlockState state, Random rand) {
		...
		if (crop instanceof BlockReed || crop instanceof BlockCactus || crop instanceof BlockDyeReeds) {
