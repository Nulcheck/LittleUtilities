...
public class BlockMagmaReservoir extends BlockContainerBase {
	public BlockMagmaReservoir(String name, Material mat, List<Block> blockList, List<Item> itemList) {
