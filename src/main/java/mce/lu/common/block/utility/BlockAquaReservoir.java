...
public class BlockAquaReservoir extends BlockContainerBase {
	public BlockAquaReservoir(String name, Material mat, List<Block> blockList, List<Item> itemList) {
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntityAquaReservoir();
	}
