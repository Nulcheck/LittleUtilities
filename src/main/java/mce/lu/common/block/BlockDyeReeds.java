...
public class BlockDyeReeds extends BlockBase implements IPlantable {
	public static final PropertyInteger AGE = PropertyInteger.create("age", 0, 15);
	protected static final AxisAlignedBB REED_AABB = new AxisAlignedBB(0.125d, 0d, 0.125d, 0.875d, 1d, 0.875d);

	public BlockDyeReeds(String name, Material mat, List<Block> blockList, List<Item> itemList) {
