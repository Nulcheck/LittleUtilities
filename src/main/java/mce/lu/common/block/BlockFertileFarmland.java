...
public class BlockFertileFarmland extends BlockNoWaterFarmlandBase {
	public BlockFertileFarmland(String name, List<Block> blockList, List<Item> itemList) {
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return ModBlocks.FERTILE_DIRT.getItemDropped(getDefaultState(), rand, fortune);
	}
