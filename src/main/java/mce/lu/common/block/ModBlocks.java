...
public class ModBlocks {
	...
	public static final Block PRISMARINE_CRYSTAL_BLOCK = new BlockBase("prismarine_crystal_block", UTIL_ROCK);
	...
	// EDIBLE BLOCKS
	public static final Block PORK_BLOCK = new EdibleBlock("pork_block", Material.CLAY, PamsBalanceHandler.porkAmount,
			PamsBalanceHandler.porkSat).setHardness(0.8f);
	public static final Block COOKED_PORK_BLOCK = new EdibleBlock("cooked_pork_block", Material.CLAY, 8, 0.8f)
			.setHardness(0.8f);
	public static final Block BEEF_BLOCK = new EdibleBlock("beef_block", Material.CLAY, PamsBalanceHandler.beefAmount,
			PamsBalanceHandler.beefSat).setHardness(0.8f);
	...
	public static final Block CHICKEN_BLOCK = ((EdibleBlock) new EdibleBlock("chicken_block", Material.CLAY,
			PamsBalanceHandler.chickenAmount, PamsBalanceHandler.chickenSat))
	...
	public static final Block RABBIT_BLOCK = new EdibleBlock("rabbit_block", Material.CLAY,
			PamsBalanceHandler.rabbitAmount, PamsBalanceHandler.rabbitSat).setHardness(0.8f);
	...
	public static final Block MUTTON_BLOCK = new EdibleBlock("mutton_block", Material.CLAY,
			PamsBalanceHandler.muttonAmount, PamsBalanceHandler.muttonSat).setHardness(0.8f);
	...
	public static final Block COD_BLOCK = new EdibleBlock("cod_block", Material.CLAY, PamsBalanceHandler.codAmount,
			PamsBalanceHandler.codSat).setHardness(0.8f);
	public static final Block COOKED_COD_BLOCK = new EdibleBlock("cooked_cod_block", Material.CLAY,
			PamsBalanceHandler.cookedCodAmount, PamsBalanceHandler.cookedCodSat).setHardness(0.8f);
	public static final Block SALMON_BLOCK = new EdibleBlock("salmon_block", Material.CLAY,
			PamsBalanceHandler.salmonAmount, PamsBalanceHandler.salmonSat).setHardness(0.8f);
	...
	public static final Block ROTTEN_FLESH_BLOCK = ((EdibleBlock) new EdibleBlock("rotten_flesh_block", Material.CLAY,
			PamsBalanceHandler.rottenFleshAmount, 0.1f)).setPotionEffect(MobEffects.HUNGER, 30, 0, 0.8f)
					.setHardness(0.8f);
	public static final Block APPLE_BLOCK = new EdibleBlock("apple_block", Material.CLAY,
			PamsBalanceHandler.appleAmount, PamsBalanceHandler.appleSat).setHardness(0.9f);
	...
	public static final Block NOTCH_APPLE_BLOCK = new GoldenAppleBlock("notch_apple_block", Material.CLAY, 4, 1.2f)
			.setHardness(0.9f);
	public static final Block BREAD_BLOCK = new EdibleBlock("bread_block", Material.CLAY,
			PamsBalanceHandler.breadAmount, PamsBalanceHandler.breadSat).setHardness(0.6f);
	public static final Block COOKIE_BLOCK = new EdibleBlock("cookie_block", Material.CLAY, 2,
			PamsBalanceHandler.cookieSat).setHardness(0.5f);
	public static final Block SPIDER_EYE_BLOCK = ((EdibleBlock) new EdibleBlock("spider_eye_block", Material.CLAY,
			PamsBalanceHandler.spiderEyeAmount, PamsBalanceHandler.spiderEyeSat))
					.setPotionEffect(MobEffects.POISON, 30, 0, 1f).setHardness(0.8f);
	public static final Block CARROT_BLOCK = new EdibleBlock("carrot_block", Material.CLAY,
			PamsBalanceHandler.carrotAmount, PamsBalanceHandler.carrotSat).setHardness(0.8f);
	...
	public static final Block POTATO_BLOCK = new EdibleBlock("potato_block", Material.CLAY,
			PamsBalanceHandler.potatoAmount, PamsBalanceHandler.potatoSat).setHardness(0.8f);
	...
	public static final Block POISONOUS_POTATO_BLOCK = ((EdibleBlock) new EdibleBlock("poisonous_potato_block",
			Material.CLAY, PamsBalanceHandler.potatoAmount, PamsBalanceHandler.potatoSat))
					.setPotionEffect(MobEffects.POISON, 100, 0, 0.6F).setHardness(0.8f);
	public static final Block BEETROOT_BLOCK = new EdibleBlock("beetroot_block", Material.CLAY,
			PamsBalanceHandler.beetrootAmount, PamsBalanceHandler.beetrootSat);
