...
public class ItemSpecialBlock extends ItemBase {
	private final Block block;

	public ItemSpecialBlock(String name, Block block) {
		super(name);
		this.block = block;
	}
	...
	public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand,
		...
		if (!itemstack.isEmpty() && player.canPlayerEdit(pos, facing, itemstack)
			...
			IBlockState iblockstate1 = this.block.getStateForPlacement(worldIn, pos, facing, hitX, hitY, hitZ, 0,
					player, hand);
