...
public class JEIHandler extends BlankModPlugin {
	...
	public void register(IModRegistry reg) {
		...
		reg.addDescription(new ItemStack(ModBlocks.UNSTOMPABLE_FARMLAND), ModBlocks.UNSTOMPABLE_FARMLAND.getUnlocalizedName() + ".guide");
		reg.addDescription(new ItemStack(ModBlocks.SPIKES), ModBlocks.SPIKES.getUnlocalizedName() + ".guide");
		reg.addDescription(new ItemStack(ModBlocks.POISON_SPIKES), ModBlocks.POISON_SPIKES.getUnlocalizedName() + ".guide");
		...
		reg.addDescription(new ItemStack(ModBlocks.BLAZE_ROD_BLOCK), ModBlocks.BLAZE_ROD_BLOCK.getUnlocalizedName() + ".guide");
		reg.addDescription(new ItemStack(ModBlocks.BLAZE_POWDER_BLOCK), ModBlocks.BLAZE_POWDER_BLOCK.getUnlocalizedName() + ".guide");
		reg.addDescription(new ItemStack(ModBlocks.GUNPOWDER_BLOCK), ModBlocks.GUNPOWDER_BLOCK.getUnlocalizedName() + ".guide");
		reg.addDescription(new ItemStack(ModBlocks.PAPER_BLOCK), ModBlocks.PAPER_BLOCK.getUnlocalizedName() + ".guide");
		reg.addDescription(new ItemStack(ModBlocks.FEATHER_BLOCK), ModBlocks.FEATHER_BLOCK.getUnlocalizedName() + ".guide");
		reg.addDescription(new ItemStack(ModBlocks.ENDER_PEARL_BLOCK), ModBlocks.ENDER_PEARL_BLOCK.getUnlocalizedName() + ".guide");
		reg.addDescription(new ItemStack(ModBlocks.COMPACT_DRAGON_EGG), ModBlocks.COMPACT_DRAGON_EGG.getUnlocalizedName() + ".guide");
		
		reg.addDescription(new ItemStack(ModItems.SPONGE), ModItems.SPONGE.getUnlocalizedName() + ".guide");
		reg.addDescription(new ItemStack(ModItems.ZOMBIE_CURING_KIT), ModItems.ZOMBIE_CURING_KIT.getUnlocalizedName() + ".guide");
